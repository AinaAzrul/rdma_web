...
class Cast
{
    ...
    public static function isManFloat($value): bool
    {
        switch (gettype($value)) {
            ...
            case "string":
                ...
                return $filtered === $value ||
                    in_array($value, ["NAN", "INF", "-INF"], true);
    ...
    public static function toManBool($value, ?bool $default = null): bool
    {
        ...
        throw new InvalidCastException(
            "Value can not be converted to a boolean"
        );
    }
     ...
     */
    public static function toManFiniteFloat(
        $value,
        ?float $default = null
    ): float {
        if ($value === null && $default !== null) {
        ...
        if (static::isManFiniteFloat($value) === false) {
            throw new InvalidCastException(
                "Value can not be converted to finite float"
            );
        }
    ...
    public static function toManFloat($value, ?float $default = null): float
    {
        ...
        if (static::isManFloat($value) === false) {
            throw new InvalidCastException(
                "Value can not be converted to float"
            );
        }
     ...
     * @return float|null
     */
    public static function toOptFiniteFloat(
        $value,
        ?float $default = null
    ): ?float {
        if ($value === null) {
