...
final class RowSetHelper
{
     ...
     * @return array
     */
    public static function extractAsArray(
        array $rows,
        string $columnName
    ): array {
        $values = [];
    ...
    {
        return array_values(
            array_unique(self::extractAsArray($rows, $columnName))
        );
    }
     ...
     * @api
     */
    public static function findInRowSet(
        array $rows,
        string $columnName,
        $value,
        bool $negate = false
     ...
     * @api
     */
    public static function searchInRowSet(
        array $rows,
        string $columnName,
        $value,
        bool $negate = false
