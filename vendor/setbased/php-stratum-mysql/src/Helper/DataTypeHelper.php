...
class DataTypeHelper
{
     ...
     * @return string
     */
    public static function columnTypeToPhpTypeHinting(
        array $dataTypeInfo
    ): string {
     ...
     */
    public static function escapePhpExpression(
        array $dataTypeInfo,
        string $expression
    ): string {
        switch ($dataTypeInfo["data_type"]) {
     ...
     * @return string
     */
    public static function phpTypeHintingToPhpTypeDeclaration(
        string $phpTypeHint
    ): string {
        $phpType = "";
        ...
        switch ($phpTypeHint) {
            ...
            default:
                ...
                if (sizeof($parts) == 2 && $key !== false) {
                    ...
                    $tmp = static::phpTypeHintingToPhpTypeDeclaration(
                        implode("|", $parts)
                    );
                    if ($tmp !== "") {
                        $phpType = "?" . $tmp;
