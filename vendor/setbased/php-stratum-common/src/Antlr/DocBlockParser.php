...
namespace SetBased\Stratum\Common\Antlr {
    ...
    final class DocBlockParser extends Parser
    {
        ...
        public const RULE_docblock = 0,
            RULE_description = 1,
            RULE_short_description = 2,
            RULE_long_description = 3,
            RULE_lines = 4,
            RULE_text_line = 5,
            RULE_text_part = 6,
            RULE_tags = 7,
        ...
        public function __construct(TokenStream $input)
        {
            ...
            $this->interp = new ParserATNSimulator(
                $this,
                self::$atn,
                self::$decisionToDFA,
        ...
        {
            $localContext = new Context\DocblockContext(
                $this->ctx,
                $this->getState()
            );
            ...
            try {
                ...
                switch (
                    $this->getInterpreter()->adaptivePredict(
                        $this->input,
                        0,
                        $this->ctx
                    )
        ...
        {
            $localContext = new Context\DescriptionContext(
                $this->ctx,
                $this->getState()
            );
        ...
        {
            $localContext = new Context\Short_descriptionContext(
                $this->ctx,
                $this->getState()
            );
        ...
        {
            $localContext = new Context\Long_descriptionContext(
                $this->ctx,
                $this->getState()
            );
            ...
            try {
                ...
                $alt = $this->getInterpreter()->adaptivePredict(
                    $this->input,
                    6,
                    $this->ctx
                );
        ...
        {
            $localContext = new Context\LinesContext(
                $this->ctx,
                $this->getState()
            );
        ...
        {
            $localContext = new Context\Text_lineContext(
                $this->ctx,
                $this->getState()
            );
        ...
        {
            $localContext = new Context\Text_partContext(
                $this->ctx,
                $this->getState()
            );
        ...
        {
            $localContext = new Context\TagsContext(
                $this->ctx,
                $this->getState()
            );
        ...
        {
            $localContext = new Context\TagContext(
                $this->ctx,
                $this->getState()
            );
        ...
        {
            $localContext = new Context\Tag_lineContext(
                $this->ctx,
                $this->getState()
            );
        ...
        {
            $localContext = new Context\Tag_partContext(
                $this->ctx,
                $this->getState()
            );
        ...
        {
            $localContext = new Context\Empty_linesContext(
                $this->ctx,
                $this->getState()
            );
        ...
        {
            $localContext = new Context\Leading_whitespaceContext(
                $this->ctx,
                $this->getState()
            );
        ...
        {
            $localContext = new Context\EolContext(
                $this->ctx,
                $this->getState()
            );
...
namespace SetBased\Stratum\Common\Antlr\Context {
    ...
    class DescriptionContext extends ParserRuleContext
    {
        ...
        {
            return $this->getTypedRuleContext(
                Short_descriptionContext::class,
                0
            );
        }
    ...
    class Text_lineContext extends ParserRuleContext
    {
        ...
        {
            return $this->getTypedRuleContext(
                Leading_whitespaceContext::class,
                0
            );
        }
