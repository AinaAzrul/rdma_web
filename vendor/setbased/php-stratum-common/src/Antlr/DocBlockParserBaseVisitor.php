 ...
 */
class DocBlockParserBaseVisitor extends AbstractParseTreeVisitor implements
    DocBlockParserVisitor
{
    /**
     * {@inheritdoc}
     *
     ...
     * {@see self::visitChildren()} on `context`.
     */
    public function visitShort_description(
        Context\Short_descriptionContext $context
    ) {
        return $this->visitChildren($context);
    }
     ...
     * {@see self::visitChildren()} on `context`.
     */
    public function visitLong_description(
        Context\Long_descriptionContext $context
    ) {
        return $this->visitChildren($context);
    }
     ...
     * {@see self::visitChildren()} on `context`.
     */
    public function visitLeading_whitespace(
        Context\Leading_whitespaceContext $context
    ) {
        return $this->visitChildren($context);
    }
