...
class Command
{
    ...
    public static function getDefaultName()
    {
        ...
        if (
            ...
            ($attribute = (new \ReflectionClass($class))->getAttributes(
                AsCommand::class
            ))
        ) {
    ...
    public function mergeApplicationDefinition(bool $mergeArgs = true)
    {
        ...
        $this->fullDefinition->addOptions(
            $this->application->getDefinition()->getOptions()
        );

        if ($mergeArgs) {
            $this->fullDefinition->setArguments(
                $this->application->getDefinition()->getArguments()
            );
            $this->fullDefinition->addArguments(
    ...
    public function addArgument(
        ...
        if (null !== $this->fullDefinition) {
            $this->fullDefinition->addArgument(
                new InputArgument($name, $mode, $description, $default)
            );
        }
