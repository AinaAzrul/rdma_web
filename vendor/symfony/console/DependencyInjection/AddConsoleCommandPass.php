...
class AddConsoleCommandPass implements CompilerPassInterface
{
    ...
    public function __construct(
        ...
        string $noPreloadTag = "container.no_preload",
        string $privateTagName = "container.private"
    ) {
        if (0 < \func_num_args()) {
            trigger_deprecation(
                "symfony/console",
                "5.3",
                'Configuring "%s" is deprecated.',
                __CLASS__
            );
        }
        ...
        foreach ($commandServices as $id => $tags) {
            ...
            if (null === $commandName) {
                if (
                    ...
                    $definition->hasTag($this->privateTagName)
                ) {
            ...
            if ($description) {
                ...
                $container
                    ->register("." . $id . ".lazy", LazyCommand::class)
                    ->setArguments([
                        $commandName,
                        $aliases,
                        $description,
