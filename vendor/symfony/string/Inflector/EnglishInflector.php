        ...
        foreach (self::PLURAL_MAP as $map) {
            ...
            while ($suffix[$j] === $lowerPluralRev[$j]) {
                ...
                if ($j === $suffixLength) {
                    ...
                    if ($j < $pluralLength) {
                        $nextIsVocal =
                            false !== strpos("aeiou", $lowerPluralRev[$j]);
                    ...
                    return [
                        $newBase .
                        ($firstUpper ? ucfirst($newSuffix) : $newSuffix),
                    ];
                }
        ...
        foreach (self::SINGULAR_MAP as $map) {
            ...
            while ($suffix[$j] === $lowerSingularRev[$j]) {
                ...
                if ($j === $suffixLength) {
                    ...
                    if ($j < $singularLength) {
                        $nextIsVocal =
                            false !== strpos("aeiou", $lowerSingularRev[$j]);
