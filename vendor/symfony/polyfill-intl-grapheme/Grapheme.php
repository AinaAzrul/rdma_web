...
\define(
    ...
    ((float) \PCRE_VERSION < 10
            ? (float) \PCRE_VERSION >= 8.32
            : (float) \PCRE_VERSION >= 10.39)
        ? "\X"
...
final class Grapheme
{
    ...
    public static function grapheme_extract(
        $s,
        $size,
        ...
        if (
            \GRAPHEME_EXTR_COUNT !== $type &&
            \GRAPHEME_EXTR_MAXBYTES !== $type &&
            \GRAPHEME_EXTR_MAXCHARS !== $type
        ) {
    ...
    private static function grapheme_position($s, $needle, $offset, $mode)
    {
        ...
        if ($caseInsensitive) {
            ...
            $mode = \defined("MB_CASE_FOLD_SIMPLE")
                ? \MB_CASE_FOLD_SIMPLE
                : \MB_CASE_LOWER;
        ...
        return false !== $needlePos
            ? self::grapheme_strlen(substr($s, 0, $needlePos)) + $offset
            : false;
    }
}
