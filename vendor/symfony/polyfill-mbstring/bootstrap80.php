...
if (!function_exists("mb_convert_encoding")) {
    function mb_convert_encoding(
        ...
        return p\Mbstring::mb_convert_encoding(
            $string ?? "",
            (string) $to_encoding,
            $from_encoding
        );
...
if (!function_exists("mb_decode_numericentity")) {
    function mb_decode_numericentity(
        ...
        return p\Mbstring::mb_decode_numericentity(
            (string) $string,
            $map,
            $encoding
        );
...
if (!function_exists("mb_encode_numericentity")) {
    function mb_encode_numericentity(
        ...
        return p\Mbstring::mb_encode_numericentity(
            (string) $string,
            $map,
            $encoding,
            (bool) $hex
...
if (!function_exists("mb_convert_case")) {
    function mb_convert_case(
        ...
        return p\Mbstring::mb_convert_case(
            (string) $string,
            (int) $mode,
            $encoding
        );
...
if (!function_exists("mb_detect_encoding")) {
    function mb_detect_encoding(
        ...
        return p\Mbstring::mb_detect_encoding(
            (string) $string,
            $encodings,
            (bool) $strict
        );
...
if (!function_exists("mb_substr_count")) {
    function mb_substr_count(
        ...
        return p\Mbstring::mb_substr_count(
            (string) $haystack,
            (string) $needle,
            $encoding
        );
...
if (!function_exists("mb_str_split")) {
    function mb_str_split(
        ...
        return p\Mbstring::mb_str_split(
            (string) $string,
            (int) $length,
            $encoding
        );
