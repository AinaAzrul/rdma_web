...
final class Mbstring
{
    ...
    public static function mb_convert_encoding(
        ...
        if (
            \is_array($fromEncoding) ||
            ($fromEncoding !== null && false !== strpos($fromEncoding, ","))
        ) {
        ...
        if ("HTML-ENTITIES" === $toEncoding || "HTML" === $toEncoding) {
            ...
            return preg_replace_callback(
                '/[\x80-\xFF]+/',
                [__CLASS__, "html_encoding_callback"],
                $s
            );
        }
    ...
    public static function mb_internal_encoding($encoding = null)
    {
        ...
        if (
            ...
            false !== @\iconv($normalizedEncoding, $normalizedEncoding, " ")
        ) {
    ...
    public static function mb_check_encoding($var = null, $encoding = null)
    {
        ...
        return self::mb_detect_encoding($var, [$encoding]) ||
    ...
    public static function mb_str_split(
        ...
        if (
            ...
            trigger_error(
                "mb_str_split() expects parameter 1 to be string, " .
                    \gettype($string) .
                    " given",
                \E_USER_WARNING
            );
